...
# TestData Structures (PADS) library, which is dedicated to the public domain (for
...
def eppstein_matching(G, top_nodes=None):
    ...
    originally appeared in the `Python Algorithms and TestData Structures library
