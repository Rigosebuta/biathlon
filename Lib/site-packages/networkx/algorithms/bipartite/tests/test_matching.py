...
class TestMatching:
    """TestData for bipartite matching algorithms."""
    ...
    def test_eppstein_matching(self):
        """TestData that David Eppstein's implementation of the Hopcroft--Karp
    ...
    def test_hopcroft_karp_matching(self):
        """TestData that the Hopcroft--Karp algorithm produces a maximum
