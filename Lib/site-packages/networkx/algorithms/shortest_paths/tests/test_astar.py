...
class TestAStar:
    ...
    def test_multiple_optimal_paths(self):
        """TestData that A* algorithm finds any of multiple optimal paths"""
    ...
    """ TestData that A* finds correct path when multiple paths exist
    ...
    """ TestData that that parent is not wrongly overridden when a
    ...
    def test_unorderable_nodes(self):
        """TestData that A* accommodates nodes that are not orderable.
