...
class TestNodeBoundary:
    ...
    def test_null_graph(self):
        """TestData that the null graph has empty node boundaries."""
        null = nx.null_graph()
    ...
    def test_directed(self):
        """TestData the node boundary of a directed graph."""
    ...
    def test_multigraph(self):
        """TestData the node boundary of a multigraph."""
    ...
    def test_multidigraph(self):
        """TestData the edge boundary of a multdiigraph."""
...
class TestEdgeBoundary:
    ...
    def test_directed(self):
        """TestData the edge boundary of a directed graph."""
        G = nx.DiGraph([(0, 1), (1, 2), (2, 3), (3, 4), (4, 0)])
        S = {0, 1}
    ...
    def test_multigraph(self):
        """TestData the edge boundary of a multigraph."""
        G = nx.MultiGraph(list(nx.cycle_graph(5).edges()) * 2)
        S = {0, 1}
        boundary = list(nx.edge_boundary(G, S))
