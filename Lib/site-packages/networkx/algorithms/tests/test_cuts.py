...
class TestCutSize:
    ...
    def test_symmetric(self):
        """TestData that the cut size is symmetric."""
    ...
    def test_single_edge(self):
        """TestData for a cut of a single edge."""
        G = nx.barbell_graph(3, 0)
        S = {0, 1, 2}
        T = {3, 4, 5}
    ...
    def test_directed(self):
        """TestData that each directed edge is counted once in the cut."""
    ...
    def test_directed_symmetric(self):
        """TestData that a cut in a directed graph is symmetric."""
        G = nx.barbell_graph(3, 0).to_directed()
        S = {0, 1, 4}
        T = {2, 3, 5}
    ...
    def test_multigraph(self):
        """TestData that parallel edges are each counted for a cut."""
