...
class TestDagLongestPath:
    ...
    def test_unorderable_nodes(self):
        """TestData that computing the longest path does not depend on
...
class TestDagToBranching:
    ...
    def test_single_root(self):
        """TestData that a directed acyclic graph with a single degree
    ...
    def test_multiple_roots(self):
        """TestData that a directed acyclic graph with multiple degree zero
    ...
    #     """TestData that node attributes are copied in the branching."""
    #     G = nx.DiGraph([(0, 1), (0, 2), (1, 3), (2, 3)])
    #     for v in G:
    ...
    def test_already_arborescence(self):
        """TestData that a directed acyclic graph that is already an
    ...
    def test_already_branching(self):
        """TestData that a directed acyclic graph that is already a
    ...
    def test_not_acyclic(self):
        """TestData that a non-acyclic graph causes an exception."""
