...
class TestQuotient:
    ...
    def test_quotient_graph_complete_multipartite(self):
        """TestData that the quotient graph of the complete *n*-partite graph
    ...
    def test_quotient_graph_complete_bipartite(self):
        """TestData that the quotient graph of the complete bipartite graph under
    ...
    def test_quotient_graph_edge_relation(self):
        """TestData for specifying an alternate edge relation for the quotient
        graph.
...
class TestContraction:
    ...
    def test_undirected_node_contraction(self):
        """TestData for node contraction in an undirected graph."""
        G = nx.cycle_graph(4)
    ...
    def test_directed_node_contraction(self):
        """TestData for node contraction in a directed graph."""
    ...
    def test_create_multigraph(self):
        """TestData that using a MultiGraph creates multiple edges."""
    ...
    def test_multigraph_keys(self):
        """TestData that multiedge keys are reset in new graph."""
        G = nx.path_graph(3, create_using=nx.MultiGraph())
        G.add_edge(0, 1, 5)
        G.add_edge(0, 0, 0)
        G.add_edge(0, 2, 5)
    ...
    def test_node_attributes(self):
        """TestData that node contraction preserves node attributes."""
        G = nx.cycle_graph(4)
    ...
    def test_without_self_loops(self):
        """TestData for node contraction without preserving self-loops."""
        G = nx.cycle_graph(4)
    ...
    def test_contract_selfloop_graph(self):
        """TestData for node contraction when nodes have selfloops."""
        G = nx.cycle_graph(4)
        G.add_edge(0, 0)
        actual = nx.contracted_nodes(G, 0, 1)
    ...
    def test_undirected_edge_contraction(self):
        """TestData for edge contraction in an undirected graph."""
        G = nx.cycle_graph(4)
