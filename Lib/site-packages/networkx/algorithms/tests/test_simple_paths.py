...
class TestIsSimplePath:
    ...
    def test_empty_list(self):
        """TestData that the empty list is not a valid path, since there
    ...
    def test_trivial_path(self):
        """TestData that the trivial path, a path of length one, is
    ...
    def test_trivial_nonpath(self):
        """TestData that a list whose sole element is an object not in the
...
# TestData for all_simple_edge_paths
...
# TestData for shortest_simple_paths
