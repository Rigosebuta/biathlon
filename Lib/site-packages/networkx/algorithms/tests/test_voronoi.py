...
class TestVoronoiCells:
    ...
    def test_isolates(self):
        """TestData that a graph with isolated nodes has all isolates in
    ...
    def test_directed_inward(self):
        """TestData that reversing the graph gives the "inward" Voronoi
        partition.
    ...
    def test_multigraph_unweighted(self):
        """TestData that the Voronoi cells for a multigraph are the same as
        for a simple graph.
