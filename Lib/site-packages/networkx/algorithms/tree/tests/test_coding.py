...
class TestPruferSequence:
    ...
    def test_encoding(self):
        """TestData for encoding a tree as a Prüfer sequence using the
        iterative strategy.
    ...
    def test_decoding(self):
        """TestData for decoding a tree from a Prüfer sequence."""
        # Example from Wikipedia.
        sequence = [3, 3, 3, 4]
    ...
    def test_inverse(self):
        """TestData that the encoding and decoding functions are inverses.
