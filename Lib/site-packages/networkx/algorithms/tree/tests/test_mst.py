...
class TestBoruvka(MinimumSpanningTreeTestBase):
    ...
    def test_unicode_name(self):
        """TestData that using a Unicode string can correctly indicate
        Borůvka's algorithm.
...
class MultigraphMSTTestBase(MinimumSpanningTreeTestBase):
    ...
    def test_multigraph_keys_min(self):
        """TestData that the minimum spanning edges of a multigraph
        preserves edge keys.
    ...
    def test_multigraph_keys_max(self):
        """TestData that the maximum spanning edges of a multigraph
        preserves edge keys.
