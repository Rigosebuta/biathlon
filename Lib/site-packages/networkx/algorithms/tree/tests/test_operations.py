...
class TestJoin:
    ...
    def test_empty_sequence(self):
        """TestData that joining the empty sequence results in the tree
        with one node.
    ...
    def test_single(self):
        """TestData that joining just one tree yields a tree with one more
        node.
    ...
    def test_basic(self):
        """TestData for joining multiple subtrees at a root node."""
