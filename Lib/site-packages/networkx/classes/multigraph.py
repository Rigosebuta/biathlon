...
class MultiGraph(Graph):
    ...
    incoming_graph_data : input graph (optional, default: None)
        TestData to initialize graph. If None (default) an empty
    ...
    **Subclasses (Advanced):**
    ...
    def __init__(self, incoming_graph_data=None, **attr):
        ...
        incoming_graph_data : input graph
            TestData to initialize graph.  If incoming_graph_data=None (default)
    ...
    def copy(self, as_view=False):
        ...
        TestData Reference (Shallow) -- For a shallow copy the graph structure
        ...
        Fresh TestData -- For fresh data, the graph structure is copied while
