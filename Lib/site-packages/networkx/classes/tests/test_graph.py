...
class BaseGraphTester:
    """ TestData for data-structure independent graph class features."""
    ...
    def test_nbunch_iter_node_format_raise(self):
        # TestData that a node that would have failed string formatting
...
class BaseAttrGraphTester(BaseGraphTester):
    """ TestData of graph class attribute features."""
...
class TestGraph(BaseAttrGraphTester):
    """TestData specific to dict-of-dict-of-dict graph data structure"""
...
class TestEdgeSubgraph:
    ...
    def test_correct_nodes(self):
        """TestData that the subgraph has the correct nodes."""
        assert [0, 1, 3, 4] == sorted(self.H.nodes())

    def test_correct_edges(self):
        """TestData that the subgraph has the correct edges."""
        assert [(0, 1, "edge01"), (3, 4, "edge34")] == sorted(self.H.edges(data="name"))

    def test_add_node(self):
        """TestData that adding a node to the original graph does not
    ...
    def test_remove_node(self):
        """TestData that removing a node in the original graph does
        affect the nodes of the subgraph.
    ...
    def test_node_attr_dict(self):
        """TestData that the node attribute dictionary of the two graphs is
        the same object.
    ...
    def test_edge_attr_dict(self):
        """TestData that the edge attribute dictionary of the two graphs is
        the same object.
    ...
    def test_graph_attr_dict(self):
        """TestData that the graph attribute dictionary of the two graphs
        is the same object.
