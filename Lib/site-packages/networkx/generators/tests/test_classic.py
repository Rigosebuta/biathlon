...
class TestGeneratorClassic:
    def test_balanced_tree(self):
        # balanced_tree(r,Tests) is a tree with (r**(Tests+1)-1)/(r-1) edges
    ...
    def test_balanced_tree_path(self):
        """TestData that the balanced tree with branching factor one is the
        path graph.
    ...
    def test_complete_0_partite_graph(self):
        """TestData that the complete 0-partite graph is the null graph."""
    ...
    def test_complete_1_partite_graph(self):
        """TestData that the complete 1-partite graph is the empty graph."""
    ...
    def test_complete_2_partite_graph(self):
        """TestData that the complete 2-partite graph is the complete bipartite
        graph.
    ...
    def test_complete_multipartite_graph(self):
        """TestData for generating the complete multipartite graph."""
