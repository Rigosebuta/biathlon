...
class TestConfigurationModel:
    ...
    def test_empty_degree_sequence(self):
        """TestData that an empty degree sequence yields the null graph."""
        G = nx.configuration_model([])
        assert len(G) == 0

    def test_degree_zero(self):
        """TestData that a degree sequence of all zeros yields the empty
        graph.
    ...
    def test_degree_sequence(self):
        """TestData that the degree sequence of the generated graph matches
    ...
    def test_random_seed(self):
        """TestData that each call with the same random seed generates the
        same graph.
    ...
    def test_directed_disallowed(self):
        """TestData that attempting to create a configuration model graph
    ...
    def test_odd_degree_sum(self):
        """TestData that a degree sequence whose sum is odd yields an
        exception.
