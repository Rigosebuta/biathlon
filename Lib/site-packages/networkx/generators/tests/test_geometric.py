...
class TestRandomGeometricGraph:
    ...
    def test_distances(self):
        """TestData that pairs of vertices adjacent if and only if they are
    ...
    def test_p(self):
        """TestData for providing an alternate distance metric to the
        generator.
    ...
    def test_node_names(self):
        """TestData using values other than sequential numbers as node IDs.
...
class TestSoftRandomGeometricGraph:
    ...
    def test_p_dist_default(self):
        """TestData default p_dict = 0.5 returns graph with edge count <= RGG with
    ...
    def test_p_dist_zero(self):
        """TestData if p_dict = 0 returns disconencted graph with 0 edges
...
class TestGeographicalThresholdGraph:
    ...
    def test_distances(self):
        """TestData that pairs of vertices adjacent if and only if their
...
class TestThresholdedRandomGeometricGraph:
    ...
    def test_theta(self):
        """TestData that pairs of vertices adjacent if and only if their sum
