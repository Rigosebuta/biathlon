...
class TestTriangularLatticeGraph:
    "TestData for :func:`networkx.generators.lattice.triangular_lattice_graph`"

    def test_lattice_points(self):
        """TestData that the graph is really a triangular lattice."""
    ...
    def test_directed(self):
        """TestData for creating a directed triangular lattice."""
    ...
    def test_multigraph(self):
        """TestData for creating a triangular lattice multigraph."""
        G = nx.triangular_lattice_graph(3, 4, create_using=nx.Graph())
...
class TestHexagonalLatticeGraph:
    "TestData for :func:`networkx.generators.lattice.hexagonal_lattice_graph`"

    def test_lattice_points(self):
        """TestData that the graph is really a hexagonal lattice."""
    ...
    def test_directed(self):
        """TestData for creating a directed hexagonal lattice."""
    ...
    def test_multigraph(self):
        """TestData for creating a hexagonal lattice multigraph."""
        G = nx.hexagonal_lattice_graph(3, 5, create_using=nx.Graph())
