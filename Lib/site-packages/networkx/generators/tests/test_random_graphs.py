...
class TestGeneratorsRandom:
    ...
    def test_dual_barabasi_albert(self, m1=1, m2=4, p=0.5):
        """
        TestData that the dual BA random graph generated behaves consistently.

        TestData the exceptions are raised as expected.
    ...
    def test_extended_barabasi_albert(self, m=2):
        """
        TestData that the extended BA random graph generated behaves consistently.
    ...
    def test_random_zero_regular_graph(self):
        """TestData that a 0-regular graph has the correct number of nodes and
        edges.
