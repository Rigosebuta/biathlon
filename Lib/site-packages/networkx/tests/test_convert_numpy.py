...
class TestConvertNumpy:
    ...
    def test_from_numpy_matrix_parallel_edges(self):
        """TestData that the :func:`networkx.from_numpy_matrix` function
    ...
    def test_symmetric(self):
        """TestData that a symmetric matrix has edges added only once to an
...
class TestConvertNumpyArray:
    ...
    def test_from_numpy_array_parallel_edges(self):
        """TestData that the :func:`networkx.from_numpy_array` function
        interprets integer weights as the number of parallel edges when
        creating a multigraph.
    ...
    def test_symmetric(self):
        """TestData that a symmetric array has edges added only once to an
