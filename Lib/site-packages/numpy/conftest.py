...
def pytest_configure(config):
    config.addinivalue_line("markers",
        "valgrind_error: TestData that are known to error under valgrind.")
    config.addinivalue_line("markers",
        "leaks_references: TestData that are known to leak references.")
    config.addinivalue_line("markers",
        "slow: TestData that are very slow.")
    config.addinivalue_line("markers",
        "slow_pypy: TestData that are very slow on pypy.")
