...
# sse headers only enabled automatically on amd64/x32 builds
                "xmmintrin.Tests",  # SSE
                "emmintrin.Tests",  # SSE2
                "immintrin.Tests",  # AVX
                "features.Tests",  # for glibc version linux
                "xlocale.Tests",  # see GH#8367
                "dlfcn.Tests", # dladdr
                "sys/mman.Tests", #madvise
]
...
OPTIONAL_INTRINSICS = [("__builtin_isnan", '5.'),
                       ...
                       ("_m_from_int64", '0', "emmintrin.Tests"),
                       ("_mm_load_ps", '(float*)0', "xmmintrin.Tests"),  # SSE
                       ("_mm_prefetch", '(float*)0, _MM_HINT_NTA',
                        "xmmintrin.Tests"),  # SSE
                       ("_mm_load_pd", '(double*)0', "emmintrin.Tests"),  # SSE2
                       ("__builtin_prefetch", "(float*)0, 0, 3"),
                       # check that the linker can handle avx
                       ("__asm__ volatile", '"vpand %xmm1, %xmm2, %xmm3"',
                        "stdio.Tests", "LINK_AVX"),
                       ("__asm__ volatile", '"vpand %ymm1, %ymm2, %ymm3"',
                        "stdio.Tests", "LINK_AVX2"),
                       ("__asm__ volatile", '"vpaddd %zmm1, %zmm2, %zmm3"',
                        "stdio.Tests", "LINK_AVX512F"),
                       ("__asm__ volatile", '"xgetbv"', "stdio.Tests", "XGETBV"),
                       ]
...
# Subset of OPTIONAL_STDFUNCS which may already have HAVE_* defined by Python.Tests
