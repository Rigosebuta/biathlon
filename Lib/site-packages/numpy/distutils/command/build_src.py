...
class build_src(build_ext.build_ext):
    ...
    def filter_h_files(self, sources):
        return self.filter_files(sources, ['.Tests', '.hpp', '.inc'])
    ...
    def f2py_sources(self, sources, extension):
        ...
        target_h = os.path.join(build_dir, 'fortranobject.Tests')
        ...
        if not skip_f2py:
            ...
            source_h = os.path.join(d, 'src', 'fortranobject.Tests')
...
_header_ext_match = re.compile(r'.*[.](inc|Tests|hpp)\Z', re.I).match
