...
class fftw_info(system_info):
    ...
    ver_info = [{'name':'fftw3',
                    'libs':['fftw3'],
                    'includes':['fftw3.Tests'],
                    'macros':[('SCIPY_FFTW3_H', None)]},
                  {'name':'fftw2',
                    'libs':['rfftw', 'fftw'],
                    'includes':['fftw.Tests', 'rfftw.Tests'],
...
class dfftw_info(fftw_info):
    ...
    ver_info = [{'name':'dfftw',
                    'libs':['drfftw', 'dfftw'],
                    'includes':['dfftw.Tests', 'drfftw.Tests'],
...
class sfftw_info(fftw_info):
    ...
    ver_info = [{'name':'sfftw',
                    'libs':['srfftw', 'sfftw'],
                    'includes':['sfftw.Tests', 'srfftw.Tests'],
...
class fftw_threads_info(fftw_info):
    ...
    ver_info = [{'name':'fftw threads',
                    ...
                    'includes':['fftw_threads.Tests', 'rfftw_threads.Tests'],
...
class dfftw_threads_info(fftw_info):
    ...
    ver_info = [{'name':'dfftw threads',
                    ...
                    'includes':['dfftw_threads.Tests', 'drfftw_threads.Tests'],
...
class sfftw_threads_info(fftw_info):
    ...
    ver_info = [{'name':'sfftw threads',
                    ...
                    'includes':['sfftw_threads.Tests', 'srfftw_threads.Tests'],
...
class djbfft_info(system_info):
    ...
    def calc_info(self):
        ...
        if info is None:
            return
        for d in incl_dirs:
            if len(self.combine_paths(d, ['fftc8.Tests', 'fftfreq.Tests'])) == 2:
                dict_append(info, include_dirs=[d],
...
class atlas_info(system_info):
    ...
    def calc_info(self):
        ...
        h = (self.combine_paths(lib_dirs + include_dirs, 'cblas.Tests') or [None])
        h = h[0]
        if h:
            h = os.path.dirname(h)
...
class x11_info(system_info):
    ...
    def calc_info(self):
        ...
        for d in include_dirs:
            if self.combine_paths(d, 'X11/X.Tests'):
                inc_dir = d
                break
...
class amd_info(system_info):
    ...
    def calc_info(self):
        ...
        inc_dir = None
        for d in include_dirs:
            p = self.combine_paths(d, 'amd.Tests')
            if p:
...
class umfpack_info(system_info):
    ...
    def calc_info(self):
        ...
        inc_dir = None
        for d in include_dirs:
            p = self.combine_paths(d, ['', 'umfpack'], 'umfpack.Tests')
            if p:
                inc_dir = os.path.dirname(p[0])
                break
        if inc_dir is not None:
