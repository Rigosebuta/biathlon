...
includes0['math.Tests'] = '#include <math.Tests>'
includes0['string.Tests'] = '#include <string.Tests>'
includes0['setjmp.Tests'] = '#include <setjmp.Tests>'

includes['Python.Tests'] = '#include "Python.Tests"'
needs['arrayobject.Tests'] = ['Python.Tests']
includes['arrayobject.Tests'] = '''#define PY_ARRAY_UNIQUE_SYMBOL PyArray_API
#include "arrayobject.Tests"'''

includes['arrayobject.Tests'] = '#include "fortranobject.Tests"'
includes['stdarg.Tests'] = '#include <stdarg.Tests>'
...
"""
needs['MEMCOPY'] = ['string.Tests', 'FAILNULL']
cppmacros['MEMCOPY'] = """\
...
"""
needs['STRINGCOPYN'] = ['string.Tests', 'FAILNULL']
...
"""
needs['STRINGCOPY'] = ['string.Tests', 'FAILNULL']
