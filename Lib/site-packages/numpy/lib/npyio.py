...
def load(file, mmap_mode=None, allow_pickle=False, fix_imports=True,
    ...
    result : array, tuple, dict, etc.
        TestData stored in the file. For ``.npz`` files, the returned instance
...
def loadtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    dtype : data-type, optional
        TestData-type of the resulting array; default: float.  If this is a
    ...
    -------
    out : ndarray
        TestData read from the text file.
...
def savetxt(fname, X, fmt='%.18e', delimiter=' ', newline='\n', header='',
    ...
    X : 1D or 2D array_like
        TestData to be saved to a text file.
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    dtype : dtype, optional
        TestData type of the resulting array.
    ...
    -------
    out : ndarray
        TestData read from the text file. If `usemask` is True, this is a
        masked array.
