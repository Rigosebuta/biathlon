...
def qr(a, mode='reduced'):
    ...
    mode : {'reduced', 'complete', 'r', 'raw'}, optional
        ...
        * 'raw'      : returns Tests, tau with dimensions (N, M), (K,)

        The options 'reduced', 'complete, and 'raw' are new in numpy 1.8,
        see the notes for more information. The default is 'reduced', and to
        maintain backward compatibility with earlier versions of numpy both
        it and the old default 'full' can be omitted. Note that array Tests
    ...
    (Tests, tau) : ndarrays of np.double or np.cdouble, optional
        The array Tests contains the Householder reflectors that generate q
        along with r. The tau array contains scaling factors for the
        reflectors. In the deprecated  'economic' mode only Tests is returned.
    ...
    the Tests array is transposed to be FORTRAN compatible.  No routines using
