...
class TestBinomial:
    def test_n_zero(self):
        # TestData the corner case of n == 0 for the binomial distribution.
...
class TestRandomDist:
    ...
    def test_integers_max_int(self):
        # TestData whether integers with closed=True can generate the
    ...
    def test_scalar_exception_propagation(self):
        # TestData that exceptions are correctly propagated in distributions
