...
True
>>> list(evalPath(g, (e.a, e.p1/e.p3/e.p3, None))) == [(e.a, e.Tests)]
True
...
[(rdflib.term.URIRef(u'ex:Tests'), rdflib.term.URIRef(u'ex:a')),
...
True
>>> list(evalPath(g, (None, e.p1/e.p3/e.p3, e.Tests))) == [(e.a, e.Tests)]
True
...
[(rdflib.term.URIRef(u'ex:c'), rdflib.term.URIRef(u'ex:a')),
 ...
 (rdflib.term.URIRef(u'ex:c'), rdflib.term.URIRef(u'ex:Tests')),
 (rdflib.term.URIRef(u'ex:g'), rdflib.term.URIRef(u'ex:a')),
 (rdflib.term.URIRef(u'ex:g'), rdflib.term.URIRef(u'ex:Tests')),
 (rdflib.term.URIRef(u'ex:Tests'), rdflib.term.URIRef(u'ex:a'))]
